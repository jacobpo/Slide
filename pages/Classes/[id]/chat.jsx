...
function MainChat(props) {
  ...
  const [textposition, setTextPosition] = useState(
    'absolute top-40 left-40 ml-10',
  )
  const [buttonposition, setButtonPosition] = useState(
    'fixed bottom-5 left-40 ml-10',
  )
  const [textlength, setTextLength] = useState(
    'w-[1000px] border-slate-900 border-[1px] rounded-lg pl-2 h-[50px]',
  )
  ...
  useEffect(() => {
    ...
    if (window.innerWidth < 600) {
      ...
      setTextLength(
        'ml-5 w-[300px] border-slate-900 border-[1px] rounded-lg pl-2 h-[50px]',
      )
    }
  }, [router.isReady])
    ...
    return (
      <>
        ...
        <Sidebar
          ...
          removeContent={() => setShowContent(false)}
        />
          ...
          <div>
            ...
            <div className={buttonposition}>
              <div className=" border-5 border-black">
                ...
                />
                <button onClick={onSubmit} className="ml-3">
                  Post
                </button>
              </div>
            </div>
